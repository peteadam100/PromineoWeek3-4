...
public class Week4Assignment {
	public static void main(String[] args) throws IOException {
		...
		System.out.println("\t\tGreater? " + Array1Geater(myDoubles, myDoubles2));
		if (pauses) {System.in.read();}
		if (pauses) {System.in.read();}
		...
		System.out.println("\t\tBuy Dink? \t" + WillBuyDrink(isHotOutside, moneyInPocket));
		if (pauses) {System.in.read();}
		if (pauses) {System.in.read();}
		...
		System.out.println("\t\tCreated array: " + Arrays.toString(CreateIntArray(arrSize)));
		if (pauses) {System.in.read();}
		if (pauses) {System.in.read();}
	}
